...
class WebManager(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        web_address = setting.get("web_address", "0.0.0.0")
        web_port = setting.get("web_port", "8000")
        ...
        self.web_address = QtWidgets.QLineEdit(web_address)
        self.web_port = QtWidgets.QLineEdit(web_port)
        ...
        form.addRow("web地址", self.web_address)
        form.addRow("web端口", self.web_port)
    ...
    def start(self):
        ...
        web_address: str = self.web_address.text()
        web_port: str = self.web_port.text()
